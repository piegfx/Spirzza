...
namespace Spirzza.Interop.SpirvCross
{
    public static unsafe partial class SpirvCross
    {
        ...
        [DllImport("spirv-cross-c-shared", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern void spvc_msl_shader_interface_var_init([NativeTypeName("spvc_msl_shader_interface_var *")] spvc_msl_shader_input* var);
        ...
        [DllImport("spirv-cross-c-shared", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern void spvc_context_set_error_callback([NativeTypeName("spvc_context")] spvc_context* context, [NativeTypeName("spvc_error_callback")] IntPtr cb, void* userdata);

        [DllImport("spirv-cross-c-shared", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern spvc_result spvc_context_parse_spirv([NativeTypeName("spvc_context")] spvc_context* context, [NativeTypeName("const SpvId *")] SpvId* spirv, [NativeTypeName("size_t")] UIntPtr word_count, [NativeTypeName("spvc_parsed_ir *")] spvc_parsed_ir** parsed_ir);
        ...
        [DllImport("spirv-cross-c-shared", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern spvc_result spvc_compiler_hlsl_set_root_constants_layout([NativeTypeName("spvc_compiler")] spvc_compiler* compiler, [NativeTypeName("const spvc_hlsl_root_constants *")] spvc_hlsl_root_constants* constant_info, [NativeTypeName("size_t")] UIntPtr count);

        [DllImport("spirv-cross-c-shared", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern spvc_result spvc_compiler_hlsl_add_vertex_attribute_remap([NativeTypeName("spvc_compiler")] spvc_compiler* compiler, [NativeTypeName("const spvc_hlsl_vertex_attribute_remap *")] spvc_hlsl_vertex_attribute_remap* remap, [NativeTypeName("size_t")] UIntPtr remaps);
        ...
        [DllImport("spirv-cross-c-shared", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern spvc_result spvc_compiler_msl_add_shader_input([NativeTypeName("spvc_compiler")] spvc_compiler* compiler, [NativeTypeName("const spvc_msl_shader_interface_var *")] spvc_msl_shader_input* input);

        [DllImport("spirv-cross-c-shared", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern spvc_result spvc_compiler_msl_add_shader_input_2([NativeTypeName("spvc_compiler")] spvc_compiler* compiler, [NativeTypeName("const spvc_msl_shader_interface_var_2 *")] spvc_msl_shader_interface_var_2* input);

        [DllImport("spirv-cross-c-shared", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern spvc_result spvc_compiler_msl_add_shader_output([NativeTypeName("spvc_compiler")] spvc_compiler* compiler, [NativeTypeName("const spvc_msl_shader_interface_var *")] spvc_msl_shader_input* output);

        [DllImport("spirv-cross-c-shared", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern spvc_result spvc_compiler_msl_add_shader_output_2([NativeTypeName("spvc_compiler")] spvc_compiler* compiler, [NativeTypeName("const spvc_msl_shader_interface_var_2 *")] spvc_msl_shader_interface_var_2* output);
        ...
        [DllImport("spirv-cross-c-shared", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern spvc_bool spvc_compiler_msl_is_shader_output_used([NativeTypeName("spvc_compiler")] spvc_compiler* compiler, [NativeTypeName("unsigned int")] uint location);
        ...
        [DllImport("spirv-cross-c-shared", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern spvc_result spvc_resources_get_resource_list_for_type([NativeTypeName("spvc_resources")] spvc_resources* resources, spvc_resource_type type, [NativeTypeName("const spvc_reflected_resource **")] spvc_reflected_resource** resource_list, [NativeTypeName("size_t *")] UIntPtr* resource_size);

        [DllImport("spirv-cross-c-shared", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern spvc_result spvc_resources_get_builtin_resource_list_for_type([NativeTypeName("spvc_resources")] spvc_resources* resources, spvc_builtin_resource_type type, [NativeTypeName("const spvc_reflected_builtin_resource **")] spvc_reflected_builtin_resource** resource_list, [NativeTypeName("size_t *")] UIntPtr* resource_size);
        ...
        [DllImport("spirv-cross-c-shared", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern spvc_result spvc_compiler_get_entry_points([NativeTypeName("spvc_compiler")] spvc_compiler* compiler, [NativeTypeName("const spvc_entry_point **")] spvc_entry_point** entry_points, [NativeTypeName("size_t *")] UIntPtr* num_entry_points);
        ...
        [DllImport("spirv-cross-c-shared", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern spvc_result spvc_compiler_get_execution_modes([NativeTypeName("spvc_compiler")] spvc_compiler* compiler, [NativeTypeName("const SpvExecutionMode **")] SpvExecutionMode** modes, [NativeTypeName("size_t *")] UIntPtr* num_modes);
        ...
        [DllImport("spirv-cross-c-shared", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern spvc_result spvc_compiler_get_declared_struct_size([NativeTypeName("spvc_compiler")] spvc_compiler* compiler, [NativeTypeName("spvc_type")] spvc_type* struct_type, [NativeTypeName("size_t *")] UIntPtr* size);

        [DllImport("spirv-cross-c-shared", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern spvc_result spvc_compiler_get_declared_struct_size_runtime_array([NativeTypeName("spvc_compiler")] spvc_compiler* compiler, [NativeTypeName("spvc_type")] spvc_type* struct_type, [NativeTypeName("size_t")] UIntPtr array_size, [NativeTypeName("size_t *")] UIntPtr* size);

        [DllImport("spirv-cross-c-shared", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern spvc_result spvc_compiler_get_declared_struct_member_size([NativeTypeName("spvc_compiler")] spvc_compiler* compiler, [NativeTypeName("spvc_type")] spvc_type* type, [NativeTypeName("unsigned int")] uint index, [NativeTypeName("size_t *")] UIntPtr* size);
        ...
        [DllImport("spirv-cross-c-shared", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern spvc_result spvc_compiler_get_combined_image_samplers([NativeTypeName("spvc_compiler")] spvc_compiler* compiler, [NativeTypeName("const spvc_combined_image_sampler **")] spvc_combined_image_sampler** samplers, [NativeTypeName("size_t *")] UIntPtr* num_samplers);

        [DllImport("spirv-cross-c-shared", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern spvc_result spvc_compiler_get_specialization_constants([NativeTypeName("spvc_compiler")] spvc_compiler* compiler, [NativeTypeName("const spvc_specialization_constant **")] spvc_specialization_constant** constants, [NativeTypeName("size_t *")] UIntPtr* num_constants);
        ...
        [DllImport("spirv-cross-c-shared", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern spvc_result spvc_compiler_get_active_buffer_ranges([NativeTypeName("spvc_compiler")] spvc_compiler* compiler, spvc_variable_id id, [NativeTypeName("const spvc_buffer_range **")] spvc_buffer_range** ranges, [NativeTypeName("size_t *")] UIntPtr* num_ranges);
        ...
        [DllImport("spirv-cross-c-shared", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern void spvc_constant_get_subconstants([NativeTypeName("spvc_constant")] spvc_constant* constant, [NativeTypeName("const spvc_constant_id **")] spvc_constant_id** constituents, [NativeTypeName("size_t *")] UIntPtr* count);

        [DllImport("spirv-cross-c-shared", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern spvc_type_id spvc_constant_get_type([NativeTypeName("spvc_constant")] spvc_constant* constant);

        [DllImport("spirv-cross-c-shared", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern void spvc_constant_set_scalar_fp16([NativeTypeName("spvc_constant")] spvc_constant* constant, [NativeTypeName("unsigned int")] uint column, [NativeTypeName("unsigned int")] uint row, float value);

        [DllImport("spirv-cross-c-shared", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern void spvc_constant_set_scalar_fp32([NativeTypeName("spvc_constant")] spvc_constant* constant, [NativeTypeName("unsigned int")] uint column, [NativeTypeName("unsigned int")] uint row, float value);

        [DllImport("spirv-cross-c-shared", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern void spvc_constant_set_scalar_fp64([NativeTypeName("spvc_constant")] spvc_constant* constant, [NativeTypeName("unsigned int")] uint column, [NativeTypeName("unsigned int")] uint row, double value);

        [DllImport("spirv-cross-c-shared", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern void spvc_constant_set_scalar_u32([NativeTypeName("spvc_constant")] spvc_constant* constant, [NativeTypeName("unsigned int")] uint column, [NativeTypeName("unsigned int")] uint row, [NativeTypeName("unsigned int")] uint value);

        [DllImport("spirv-cross-c-shared", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern void spvc_constant_set_scalar_i32([NativeTypeName("spvc_constant")] spvc_constant* constant, [NativeTypeName("unsigned int")] uint column, [NativeTypeName("unsigned int")] uint row, int value);

        [DllImport("spirv-cross-c-shared", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern void spvc_constant_set_scalar_u16([NativeTypeName("spvc_constant")] spvc_constant* constant, [NativeTypeName("unsigned int")] uint column, [NativeTypeName("unsigned int")] uint row, [NativeTypeName("unsigned int")] uint value);

        [DllImport("spirv-cross-c-shared", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern void spvc_constant_set_scalar_i16([NativeTypeName("spvc_constant")] spvc_constant* constant, [NativeTypeName("unsigned int")] uint column, [NativeTypeName("unsigned int")] uint row, int value);

        [DllImport("spirv-cross-c-shared", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern void spvc_constant_set_scalar_u8([NativeTypeName("spvc_constant")] spvc_constant* constant, [NativeTypeName("unsigned int")] uint column, [NativeTypeName("unsigned int")] uint row, [NativeTypeName("unsigned int")] uint value);

        [DllImport("spirv-cross-c-shared", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern void spvc_constant_set_scalar_i8([NativeTypeName("spvc_constant")] spvc_constant* constant, [NativeTypeName("unsigned int")] uint column, [NativeTypeName("unsigned int")] uint row, int value);
        ...
        [DllImport("spirv-cross-c-shared", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern spvc_result spvc_compiler_get_declared_capabilities([NativeTypeName("spvc_compiler")] spvc_compiler* compiler, [NativeTypeName("const SpvCapability **")] SpvCapability** capabilities, [NativeTypeName("size_t *")] UIntPtr* num_capabilities);

        [DllImport("spirv-cross-c-shared", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern spvc_result spvc_compiler_get_declared_extensions([NativeTypeName("spvc_compiler")] spvc_compiler* compiler, [NativeTypeName("const char ***")] sbyte*** extensions, [NativeTypeName("size_t *")] UIntPtr* num_extensions);
        ...
        [DllImport("spirv-cross-c-shared", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern spvc_result spvc_compiler_get_buffer_block_decorations([NativeTypeName("spvc_compiler")] spvc_compiler* compiler, spvc_variable_id id, [NativeTypeName("const SpvDecoration **")] SpvDecoration** decorations, [NativeTypeName("size_t *")] UIntPtr* num_decorations);

        [NativeTypeName("#define SPVC_C_API_VERSION_MAJOR 0")]
        public const int SPVC_C_API_VERSION_MAJOR = 0;

        [NativeTypeName("#define SPVC_C_API_VERSION_MINOR 55")]
        public const int SPVC_C_API_VERSION_MINOR = 55;
